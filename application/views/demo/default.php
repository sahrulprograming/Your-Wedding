...
<div class="content" id="pembungkus-konten">
    ...
    <!-- Hero -->
    <section class="" id="hero" style="background-image: linear-gradient(rgba(46,27,23,0.7),rgba(46,27,23,0.7)), url(<?= base_url('assets'); ?>/demo/image/hero.jpg); background-repeat: no-repeat;background-size: cover;">
        <div class="hero text-center" data-aos="fade-right" data-aos-duration="1200">
            <div class="judul">
                <h1>Undangan Pernikahan</h1>
            </div>
            <img src="<?= base_url('assets'); ?>/demo/element/Line diamond.svg" alt="">
            ...
            <div class="akad card-jadwal mt-4">
                <div class="judul">
                    <div class="judul d-flex align-items-center justify-content-center">
                        <img class="me-2" src="<?= base_url('assets'); ?>/demo/icon/countdownsvg.svg" alt="countdown" width="25" height="25">
    ...
    <!-- Profile Mempelai -->
    <section class="" id="profile-mempelai" style="background-image: url(<?= base_url('assets'); ?>/demo/image/bg2.jpg); background-size: cover;">
        <div class="profile-mempelai text-center" data-aos="fade-left" data-aos-duration="1200">
            <img class="bunga-atas" src="<?= base_url('assets'); ?>/demo/element/bunga.png" width="400" height="142">
            <div class="card-profile">
                ...
                <div class="row position-relative justify-content-center ">
                    <div class="wanita col-46-mod p-0 ">
                        <img class="lingkaran-bunga-wanita1" src="<?= base_url('assets'); ?>/demo/element/lingkaran_foto.png" alt="Lingkaran Bunga">
                        <img class="lingkaran-bunga-wanita2" src="<?= base_url('assets'); ?>/demo/element/lingkaran_foto.png" alt="Lingkaran Bunga">
                    ...
                    <img class="cincin position-absolute" src="<?= base_url('assets'); ?>/demo/icon/rings.svg" alt="Cincin" width="54" height="40">
                    <div class="pria col-46-mod p-0 ">
                        <img class="lingkaran-bunga-pria1" src="<?= base_url('assets'); ?>/demo/element/lingkaran_foto.png" alt="Lingkaran Bunga">
                        <img class="lingkaran-bunga-pria2" src="<?= base_url('assets'); ?>/demo/element/lingkaran_foto.png" alt="Lingkaran Bunga">
            ...
            <img class="bunga-bawah" src="<?= base_url('assets'); ?>/demo/element/bunga.png" width="400" height="142">
        </div>
    </section>
    ...
    <!-- Lokasi Acara -->
    <section class="align-items-start" id="lokasi-acara" style="background-image: url(<?= base_url('assets'); ?>/demo/image/bg2.jpg); background-size: cover;">
        <div class="jadwal text-center d-flex flex-column align-items-center justify-content-start my-4" data-aos="fade-right" data-aos-duration="1200">
            <!-- Akad -->
            <div class="akad card-jadwal">
                <div class="judul">
    ...
    <!-- Do'a dan Ucapan -->
    <section class="align-items-start" id="doa-ucapan" style="background-image: url(<?= base_url('assets'); ?>/demo/image/bg2.jpg); background-size: cover;">
